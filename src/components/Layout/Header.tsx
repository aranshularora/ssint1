        ...
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">S.S. International</h1>
                <p className="text-sm text-gray-600">Where Accuracy Meets Reliability</p>
              </div>
            </Link>
          </div>
